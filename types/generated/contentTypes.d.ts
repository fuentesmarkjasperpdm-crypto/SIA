...
export interface ApiMedicineMedicine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DosageForm: Schema.Attribute.Enumeration<
      ['Tablet', 'Syrup', 'Capsule', 'Injectable']
    > &
      Schema.Attribute.Required;
    ...
    >;
    Stock: Schema.Attribute.Component<'inventory.stock-inventory', true>;
...
export interface ApiPurchaseOrderLinePurchaseOrderLine
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    UnitPriceAtOrdered: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    OrdateDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
